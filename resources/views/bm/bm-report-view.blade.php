			...
			<div class="card">
				...
				<div class="card-body">
					<ul class="nav nav-pills nav-secondary" id="pills-tab" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Pending Report</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-profile" aria-selected="false">Commented Back Report</a>
						</li>
						<li class="nav-item">
																...
																@endif
																	...
																	<td>
																		<div class="form-button-action">
																			<a href="{{route('bm-single-report-view',$staff_report_comment_status_0->id)}}">
														...
														<table id="add-row1" class="display table table-striped table-hover" >
															...
															<tbody>
																...
																<tr>
																	...
																	<td>
																		<div class="form-button-action">
																			<a href="{{route('bm-single-report-view',$report_comment_status_1->id)}}">
																			<button type="button" data-toggle="tooltip" title=""  class="badge badge-pill jatu-green px-3 py-2 white ml-2" data-original-title="view report">
																					<i class="fa fa-eye"></i>
																				</button>
																			</a>
													...
													<div class="table-responsive">
														<table id="add-row2" class="display table table-striped table-hover" >
															...
															<tbody>
																...
																<tr>
																	@if($report_comment_status_3 == [])
																	<td></td>
																	@else
																	<td>{{$report_comment_status_3->user->first_name}} 
																		{{$report_comment_status_3->user->last_name}}
																	</td>
																	@endif
																	<td>{{ $report_comment_status_1->date }}</td>
																	<td>{{ $report_comment_status_1->time_sent }}</td>
														...
														<table id="add-row3" class="display table table-striped table-hover" >
															...
															<tbody>
																...
																<tr>
																	...
																	<td>
																		<div class="form-button-action">
																			<!-- <a href="{{route('bm-single-report-view',$report_comment_status_2->id)}}">
																			<button type="button" data-toggle="tooltip" title=""  class="badge badge-pill jatu-green px-3 py-2 white ml-2" data-original-title="view report">
																					<i class="fa fa-eye"></i>
																				</button>
																			</a> -->

																			<a href="{{route('bm-report-view-print',$report_comment_status_2->id)}}">
																			<button type="button" data-toggle="tooltip" title=""  class="badge badge-pill jatu-green px-3 py-2 white ml-2" data-original-title="Print report">
