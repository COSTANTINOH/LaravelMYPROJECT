			...
			SweetAlert2Demo.init();
								...
								<div class="pl-5 pr-5 mr-5 ml-5 font-jatu">
									...
									@foreach($target_name as $target_name)
										<h5 style="color:black;margin-bottom:40px;">{!!$target_name!!}</h5>
									@endforeach
		
									@foreach($task_list as $key=>$task)
										<table>
											<tr>
												<h4 style="color:black;"><b>TASK:</b> {{$task->title}} <b>({{$task->time_taken}})</b></h4>
								...
								<div class="pl-5 pr-5 mr-5 ml-5 font-jatu mb-3">									
									<form action="" method="POST">
										<span style="color: black;">Your Comment For This Report</span>
										<div class="row">
