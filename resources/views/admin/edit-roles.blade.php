        ...
        <div class="page-inner">
            <div class="page-header">		
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="{{route('location-list')}}">Roles</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
                            ...
                            <div class="row">                            
                                ...
                                <form action="{{route('update-role',$roles->id)}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="target">Roles Name</label>
                                    <input type="text" class="form-control" name="role" value="{{ $roles->name }}" placeholder="Enter Location name" required>                                    
                                    </div>
                                    <div class="form-group">
