			...
			<div class="card">
				...
				<div class="card-body">
					<ul class="nav nav-pills nav-secondary" id="pills-tab" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-profile" aria-selected="false"><i class="fa fa-eye"></i> Readed opinion</a>
						</li>
					</ul>
						...
						<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
							...
							<div class="table-responsive">
								<table id="add-row" class="display table table-striped table-hover" >
									...
									@if($opinions->status == 0)
									<tr>
									<td>{{$opinions->date}}</td>
									<td>{!!Str::limit(strip_tags($opinions->description), 80,$end='.....')!!}</td>
									<td><i class="fa fa-thumbs-down"> Not read </i></td>	
									<td><a href="{{route('admin-view-full',$opinions->id)}}" class="badge badge-pill jatu-green px-3 py-2" ><i class="fa fa-eye" style="color: white"></i></td>																																																		
									</tr> 
									@endif
									@endforeach		
									</tbody>
							...
							<div class="table-responsive">
								<table id="add-row1" class="display table table-striped table-hover" >
									...
									@foreach ($opinion as $opinion)
										...
										<td><a href="{{route('admin-view-full',$opinion->id)}}" class="badge badge-pill jatu-green px-3 py-2" ><i class="fa fa-eye" style="color: white"></i></td>																																																		
										</tr> 
										@endif
										@endforeach
									</tbody>
