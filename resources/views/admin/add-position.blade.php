        ...
        <div class="page-inner">
            <div class="page-header">	
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="{{route('branch-list')}}">Positions</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
                                ...
                                <div class="col-6">
                                    <form action="{{route('create-position')}}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="target">Position Name</label>
                                            <input type="text" class="form-control" name="position" value="{{ old('branch') }}" placeholder="Enter Position name" required>                                    
                                        </div>
                                        <div class="form-group ">
