                        ...
                        <div class="card-body">
                            <div class="row">                            
                                ...
                                <form action="{{route('save-department')}}" method="POST">
                                    ...
                                    <input type="text" class="form-control" name="department" value="{{ old('department') }}" placeholder="Enter Department name" required>                                    
                                    </div>
                                    <div class="form-group">
                                        <label for="target">Department Name(Short Form)</label>
                                        <input type="text" class="form-control" name="department_short" value="{{ old('department_short') }}" placeholder="Enter Department short name eg. ICT" required>                                    
                                    </div>
                                    <div class="form-group">
