						...
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row ">
							...
							<div class="col-6">
							  <div class="avatar float-left mr-2" style="height:100px; width:100px;">
								...
								@foreach($photo_name as $pic)
						      	  <img src="/img/{{$pic->path}}"  width="100px" height="100px"  alt="..." class="avatar-img rounded-circle"> 
								@endforeach
								@endif
								</div>      
					         </div>
					         ...
					         <strong style="color:#db6e26; padding:10px; font-size:30px;">{{$data->first_name}}  {{$data->last_name}}</strong>
					                @endforeach
									@endif
							 </div>
					         </div>
							...
							<div class="card full-height">
								<div class="card-body">
									...
									@foreach($see_profile as $data)
									   ...
									   @endif
                                       <tr>
									   <td><br> <a href="{{route('edit-profile-view')}}" class="btn white jatu-green">Edit</button></td>
                                       </tr>
