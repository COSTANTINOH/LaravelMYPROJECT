						...
						<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
							...
							<div class="table-responsive">
								<table id="add-row" class="display table table-striped table-hover" >
									...
									<tbody>
										@foreach($hod_reports_today as $staff_report_comment_status_0)
										<tr>
											<td>{{ $staff_report_comment_status_0->date }}</td>
											<td>
												{{ $staff_report_comment_status_0->user->first_name }} {{ $staff_report_comment_status_0->user->middle_name }}
												{{ $staff_report_comment_status_0->user->last_name }}
											</td>
											<td>
												<div class="form-button-action">
													<a href="{{route('hr-hod-print-report-view',$staff_report_comment_status_0->id)}}">
						...
						<div class="tab-pane fade" id="pills-commented" role="tabpanel" aria-labelledby="pills-commented-tab">
							...
							<div class="table-responsive">
								<table id="add-row3" class="display table table-striped table-hover" >
									...
									<tbody>
										@foreach($hod_reports_uncommented as $hod_reports_uncommented)
										<tr>
											...
											<td>
												<div class="form-button-action">
													<a href="{{route('hr-hod-report-view',$hod_reports_uncommented->id)}}">
													<i class="fa fa-eye jatu-orange-c ml-3"></i>
													</a>
												</div>
											</td>
						...
						<div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
							...
							<div class="table-responsive">
								<table id="add-row1" class="display table table-striped table-hover" >
									...
									<tbody>
										@foreach($hod_reports_all as $report_comment_status_1)
										<tr>
											...
											<td>
												<div class="form-button-action">
													<a href="{{route('hr-hod-print-report-view',$report_comment_status_1->id)}}">
													<i class="fa fa-eye jatu-orange-c ml-3"></i>
													</a>
												</div>
											</td>
