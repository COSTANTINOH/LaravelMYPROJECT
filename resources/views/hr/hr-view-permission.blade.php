						...
						<div class="col-md-12">
							<div class="card"  id="el">
								...
								<script>
									...
									setTimeout(function(){
										window.location.href = '/hr/permission-requests';
									}, 5000);
                            	</script>
								@endif
								...
								<div class="pl-5 pr-5 mr-5 ml-5 font-jatu">
									...
									<h4 class="font-weight-bold Black">STAFF ONLY REQUEST</h4>
									<div class="row">
										<div class="col-12">
											...
											@foreach ($perm as $perm)
												<h3 class="Black">I Request</h3>
												<h5 class="Black text-justify">{!!$perm->request!!}</h5>
												<h5 class="Black text-justify">From: Date <u>{{$perm->date_from}}</u> To <u>{{$perm->date_to}}</u></h5>
									
												<h4 class="font-weight-bold Black mt-3">HEAD OF DEPARTMENT RECOMMENDATION</h4>
												<h6 class="Black"><b>Name:</b> {{App\User::find($hod_id)->first_name." ".App\User::find($hod_id)->middle_name." ".App\User::find($hod_id)->last_name}}</h6>
												<h6 class="Black"><b>Position:</b> {{App\User::find($hod_id)->position->pname}}</h6>
									...
									{{-- <h4 class="font-weight-bold Black mt-3">PART C: TO BE FILLED BY THE ADMINISTRATION DEPARTMENT ONLY</h4> --}}
									<h4 class="font-weight-bold Black mt-3">HUMAN RESOURCE MANAGER RECOMMENDATION:</h4>
									@if ($perm->hr_recommendation == NULL)
										<form action="{{route('save-hr-recommendation',request()->route('id'))}}" method="POST">
											@csrf
											...
											<div class="form-group">
												...
												<textarea class="form-control" id="editor" aria-describedby="emailHelp" placeholder="Recommendation" name="recommend_hr" rows='20' required="required"></textarea>
											</div>
									...
									@else
										...
										<h6 class="Black text-justify"><b>Recommendation:</b>{!!$perm->hr_recommendation!!}</h6>
										<h6 class="Black text-justify"><b>Date:</b>{!!$perm->hr_comment_date!!}</h6>
									@endif
