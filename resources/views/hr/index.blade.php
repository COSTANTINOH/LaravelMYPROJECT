							...
							<div class="card full-height">
								<div class="card-body">
									...
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
								      	<a href="{{route('view-all-staff')}}" style="color:black;">
										...
										<a href="{{route('view-departments')}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="dept_num"></div>
						...
						<div class="col-md-12">
							<div class="card full-height">
								<div class="card-body">
									...
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
									   <a href="{{route('department-staff',1)}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="ict"></div>
										...
										<a href="{{route('department-staff',6)}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="hr"></div>
										...
										<a href="{{route('department-staff',2)}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="finance"></div>
									...
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										...
										<a href="{{route('department-staff',5)}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
										...
										<a href="{{route('department-staff',3)}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="saccos"></div>
										...
										<a href="{{route('department-staff',4)}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
									...
									<div class="row py-3">
										<div class="col-md-12">
											...
											@foreach($report_id as $reports)
												<h2>Name : <span style="color:black;font-weight: bold;">{{ App\User::select('first_name','last_name')->where('id',App\Report::select('user_id')->where('id',$reports)->pluck('user_id')->first())->pluck('first_name','last_name')->first() }}</span> <br/> <br/></h2>
											@endforeach
										</div>
										</div>
									</div>
