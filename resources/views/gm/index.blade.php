						...
						<div class="col-md-6">
							...
							<div class="card-body">
									...
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										...
										<a href="{{route('view-all-staff-gm')}}" style="color:black;">
										...
										<a href="{{route('gm-view-departments')}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="dept_num"></div>
						...
						<div class="col-md-12">
							<div class="card full-height">
								<div class="card-body">
									...
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
									   <a href="{{route('gm-dept-staff',1)}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="ict"></div>
										...
										<a href="{{route('gm-dept-staff',6)}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="hr"></div>
										...
										<a href="{{route('gm-dept-staff',2)}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="finance"></div>
									...
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										...
										<a href="{{route('gm-dept-staff',5)}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
										...
										<a href="{{route('gm-dept-staff',3)}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="saccos"></div>
										...
										<a href="{{route('gm-dept-staff',4)}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
