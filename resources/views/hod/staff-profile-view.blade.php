		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
					<h4 class="page-title orange">Staff Profile</h4>
					<div class="row">
						<div class="col-md-8">
															...
															<div class="row mt-3">
																<div class="col-md-12">
																	<div class="form-group form-group-default">
																		...
																		{{$user->ulbd->location->lname}}{{-- <input type="text"  class="form-control jatu-white" value="{{$my_dataz->lname}}"  placeholder="Name"> --}}
																	</div>
																</div>
															</div>
								...
								<div class="card-header" style="background-image: url('../assets/img/blogpost.jpg')">
									<div class="profile-picture">
										<div class="avatar avatar-xl">
											<img src="/public/img/{{$user->photo->path}}"  alt="..." class="avatar-img rounded-circle center">
										</div>
									</div>
								</div>
								<div class="card-body ">
