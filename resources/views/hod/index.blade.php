				...
				<div class="panel-header">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="orange pb-2 fw-bold" style="font-weight: bold;">JATU REPORTING SYSTEM</h2>
								<h5 class="op-7 mb-2" style="color: black;"><?php date_default_timezone_set("Africa/Nairobi"); $date = date('Y-m-d h:m:s l'); echo "$date";?></h5>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="card full-height">
								<div class="card-body">
									...
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										...
										<a href="{{route('staffview')}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="name"></div>
											<h6 class="fw-bold mt-3 mb-0">Total staffs in a department</h6>
										</div>
										</a>

										<a href="{{url('/hod/hod-report-view')}}" style="color:black;">
										<div class="px-2 pb-2 pb-md-0 text-center">
										...
										<div class="px-2 pb-2 pb-md-0 text-center">
											...
											<h6 class="fw-bold mt-3 mb-0">Pending Reports</h6>
										</div>
										</a>
								...
								<div class="card-body card-category">
									<div class="row py-3">
										...
										<div class="card-body">
											...
											<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
												<div class="px-2 pb-2 pb-md-0 text-center">
													<div><a href="{{url('/hod/hod-report-view')}}"><i class="fa fa-book fa-3x jatu-orange-c"></i></a></div>
													<h6 class="fw-bold mt-3 mb-0">Staff Report</h6>
                                                    
												</div>
												<div class="px-2 pb-2 pb-md-0 text-center">
												<div><a href="{{route('hod-create-report')}}"><i class="fa fa-edit fa-3x jatu-orange-c"></i></a></div>
													<h6 class="fw-bold mt-3 mb-0">Create Reports</h6>
												</div>
												<div class="px-2 pb-2 pb-md-0 text-center">
												<div><a href="{{route('staffview')}}"><i class="fa fa-users fa-3x jatu-orange-c"></i></a></div>
													<h6 class="fw-bold mt-3 mb-0">staff list</h6>
												</div>
												<div class="px-2 pb-2 pb-md-0 text-center">
												<div><a href="{{route('hod-opinion-view')}}"><i class="fa fa-comments fa-3x jatu-orange-c"></i></a></div>
